        ...
        <tr>
            ...
            <td>
                <?php
                    ...
                    $dateresult = $date->format('H:i:s Y-m-d');
                    echo $dateresult;
                ?>
            </td>
        </tr> 
...
<div class="col-md-6">
    <table class="table">
        ...
        <tr>
            <td>Posts Per Day:</td>
            <td><?php echo round(($data['counts']['posts'] / $interval->days), 2); ?> (average)</td>    
        </tr>
        <tr>
            <td>Stars Per Day:</td>
            <td><?php echo round(($data['counts']['stars'] / $interval->days), 2); ?> (average)</td>    
        </tr>            
        <?php } ?>
        <?php if ($username != $auth_username) { ?>     
        <tr>
